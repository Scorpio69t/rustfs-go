...
标准 S3 API 示例（26 个示例涵盖所有常用操作）：

- **存储桶操作** (5个): 创建、删除、列出、检查存在、获取位置
- **对象操作** (9个): 上传、下载、复制、删除、统计、列出、文件上传/下载
- **版本控制** (4个): 启用、暂停、状态、列出版本
- **对象标签** (3个): 设置、获取、删除对象标签
- **存储桶策略** (3个): 设置、获取、删除存储桶策略
- **预签名 URL** (2个): GET 和 PUT 预签名 URL
